...
class AnimeControllerIT {
    ...
    private static final DevDojoUser USER = DevDojoUser.builder()
            ...
            .password("{bcrypt}$2a$10$0JMeJhnausMld4WfU7G/EeRuTPnww6NOD4VZBl6qMMchHl9H916ru")
            .username("devdojo")
    ...
    static class Config {
        ...
        public TestRestTemplate testRestTemplateRoleAdminCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
                    .rootUri("http://localhost:" + port)
                    .basicAuthentication("humberto", "academy");
            return new TestRestTemplate(restTemplateBuilder);
        }
    }
    ...
    void findByIdld_ReturnsfAnime_WhenSuccessful() {
        Anime savedAnime = animeRepository.save(AnimeCreator.createAnimeToBeSaved());
        devDojoUserRepository.save(USER);
    ...
    void findByName_ReturnsListOffAnime_WhenSuccessful() {
        Anime savedAnime = animeRepository.save(AnimeCreator.createAnimeToBeSaved());
        devDojoUserRepository.save(USER);
        String expectedName = savedAnime.getName();
    ...
    void findByName_ReturnsEmptyListOffAnime_WhenAnimeIsNotFound() {
        devDojoUserRepository.save(USER);
    ...
    void save_ReturnsfAnime_WhenSuccessful() {
        devDojoUserRepository.save(USER);
